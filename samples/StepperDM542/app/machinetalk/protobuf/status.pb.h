...
const EmcLinearUnitsType EmcLinearUnitsType_MIN = LINEAR_UNITS_INCHES;
...
class EmcToolData : public ::google::protobuf::Message {
 public:
  ...
  inline const ::pb::Position& offset() const;
  inline ::pb::Position* mutable_offset();
  inline ::pb::Position* release_offset();
  inline void set_allocated_offset(::pb::Position* offset);
...
class EmcStatusConfig : public ::google::protobuf::Message {
 public:
  ...
  inline ::pb::EmcLinearUnitsType linear_units() const;
  inline void set_linear_units(::pb::EmcLinearUnitsType value);
  ...
  inline ::pb::EmcAngularUnitsType angular_units() const;
  inline void set_angular_units(::pb::EmcAngularUnitsType value);
...
inline const ::pb::Position& EmcToolData::offset() const {
  // @@protoc_insertion_point(field_get:pb.EmcToolData.offset)
  return offset_ != NULL ? *offset_ : *default_instance_->offset_;
}
inline ::pb::Position* EmcToolData::mutable_offset() {
  set_has_offset();
  if (offset_ == NULL) offset_ = new ::pb::Position;
  // @@protoc_insertion_point(field_mutable:pb.EmcToolData.offset)
  return offset_;
}
inline ::pb::Position* EmcToolData::release_offset() {
  clear_has_offset();
  ::pb::Position* temp = offset_;
  offset_ = NULL;
  return temp;
}
inline void EmcToolData::set_allocated_offset(::pb::Position* offset) {
  delete offset_;
  offset_ = offset;
  if (offset) {
    set_has_offset();
  ...
  // @@protoc_insertion_point(field_set_allocated:pb.EmcToolData.offset)
}
...
inline ::pb::EmcLinearUnitsType EmcStatusConfig::linear_units() const {
  // @@protoc_insertion_point(field_get:pb.EmcStatusConfig.linear_units)
  return static_cast< ::pb::EmcLinearUnitsType >(linear_units_);
}
inline void EmcStatusConfig::set_linear_units(::pb::EmcLinearUnitsType value) {
  assert(::pb::EmcLinearUnitsType_IsValid(value));
...
inline ::pb::EmcAngularUnitsType EmcStatusConfig::angular_units() const {
  // @@protoc_insertion_point(field_get:pb.EmcStatusConfig.angular_units)
  return static_cast< ::pb::EmcAngularUnitsType >(angular_units_);
}
inline void EmcStatusConfig::set_angular_units(::pb::EmcAngularUnitsType value) {
  assert(::pb::EmcAngularUnitsType_IsValid(value));
...
inline ::pb::EmcCanonUnitsType EmcStatusInterp::program_units() const {
  // @@protoc_insertion_point(field_get:pb.EmcStatusInterp.program_units)
  return static_cast< ::pb::EmcCanonUnitsType >(program_units_);
}
inline void EmcStatusInterp::set_program_units(::pb::EmcCanonUnitsType value) {
  assert(::pb::EmcCanonUnitsType_IsValid(value));
  set_has_program_units();
  program_units_ = value;
  // @@protoc_insertion_point(field_set:pb.EmcStatusInterp.program_units)
}
...
template <> struct is_proto_enum< ::pb::EmcLinearUnitsType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::EmcLinearUnitsType>() {
  return ::pb::EmcLinearUnitsType_descriptor();
}
template <> struct is_proto_enum< ::pb::EmcAngularUnitsType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::pb::EmcAngularUnitsType>() {
  return ::pb::EmcAngularUnitsType_descriptor();
}

...
void protobuf_AssignDesc_machinetalk_2fprotobuf_2fpreview_2eproto() {
  protobuf_AddDesc_machinetalk_2fprotobuf_2fpreview_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "machinetalk/protobuf/preview.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_machinetalk_2fprotobuf_2fpreview_2eproto);
}
...
void protobuf_AddDesc_machinetalk_2fprotobuf_2fpreview_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\024\n\020ST_PYTHON_METHOD\020\003", 1341);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "machinetalk/protobuf/preview.proto", &protobuf_RegisterTypes);
  Position::default_instance_ = new Position();
  Preview::default_instance_ = new Preview();
  Position::default_instance_->InitAsDefaultInstance();
  Preview::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_machinetalk_2fprotobuf_2fpreview_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_machinetalk_2fprotobuf_2fpreview_2eproto {
  StaticDescriptorInitializer_machinetalk_2fprotobuf_2fpreview_2eproto() {
    protobuf_AddDesc_machinetalk_2fprotobuf_2fpreview_2eproto();
  }
} static_descriptor_initializer_machinetalk_2fprotobuf_2fpreview_2eproto_;
...
const Position& Position::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_machinetalk_2fprotobuf_2fpreview_2eproto();

...
#ifdef PB_MSGID
#define PB_MSG_1200 pb_TaskPlanExecute
#define PB_MSG_1201 pb_TaskPlanBlockDelete
#define PB_MSG_1202 pb_TaskPlanOptionalStop
#define PB_MSG_1203 pb_TaskPlanOpen
#define PB_MSG_1204 pb_TaskPlanReply
#define PB_MSG_1205 pb_TaskReply
#define PB_MSG_1206 pb_TicketUpdate

#define TASK_MESSAGES \
	PB_MSG(1200,-1,pb_TaskPlanExecute) \
	PB_MSG(1201,2,pb_TaskPlanBlockDelete) \
	PB_MSG(1202,2,pb_TaskPlanOptionalStop) \
	PB_MSG(1203,-1,pb_TaskPlanOpen) \
	PB_MSG(1204,-1,pb_TaskPlanReply) \
	PB_MSG(1205,5,pb_TaskReply) \
	PB_MSG(1206,-1,pb_TicketUpdate) \
